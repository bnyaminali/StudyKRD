...
<!-- Mirrored from www.hrf.one/contactus.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Oct 2021 19:24:05 GMT -->
...
<head>
	...
	<![endif]-->
	<script src="js/base-v3.js"></script>
...
<div class="container-fluid in-header">
	<div class='row'>
		<div class='col-sm-4 col-xs-6 no-padding user-col text-right'>
			<a href='index.html' class=''><img src='img/krg-education.png' class='image-responsive krg' /></a>
		</div>
...
<form method="post" class="form-horizontal" action='https://www.hrf.one/contactus.php?do=save' id='detailform'>
<div class='container-fluid light support'>
	<div class='container'>
		...
		<div class='row'>
			<div class='col-sm-12'>
				<div class='title bottom-border'>پەیوەندی</div>
				تۆڕی فێرکاری هەورەفێرگە بۆ خزمەت کردنی پرۆسەی خوێندن کارایە، داخوازی و بۆچوونی بەکارهێنەران و کەسانی شارەزا 
				لەم بوارەدا دەبێتە سەرمایەیەکی میللی، هەر بۆیە گرنگە هەرچی پێشنیاز، بیرۆکە یان داخوازی هەیە لەم فۆرمەدا پڕ بکرێتەوە.
			</div>
		</div>
		<div class='row'>
			<div class='col-sm-8'>
				<select id='Type' name='Type' class='form-control'><option selected value='0'>تکایە جۆری پەیام هەڵبژێرە</option><option value='1'>چاکسازی</option><option value='2'>هەڵە</option><option value='3'>سەرنج</option><option value='4'>پێشنیاز</option><option value='5'>باسی دیکە</option></select>			</div>
			<div class='col-sm-2' style='padding-left: 0px;'>
			</div>
		</div>
		<div class='row'>
			<div class='col-sm-8'>
				<select id='Class' name='Class' class='form-control'><option selected value='0'>تکایە وانە هەڵبژێرە</option><option value='1'>کوردی</option><option value='2'>ئینگلیزی</option><option value='3'>زانست</option><option value='4'>عەرەبی</option><option value='5'>کۆمەڵایەتی</option><option value='6'>بیرکاری</option><option value='7'>وانەی دیکە</option></select>			</div>
			<div class='col-sm-2' style='padding-left: 0px;'>
			</div>
		</div>
		<div class='row'>
			<div class='col-sm-8'>
				<input type='text' class='form-control' placeholder='بابەت *' name='Subject' value='' />
			</div>
			<div class='col-sm-2' style='padding-left: 0px;'>
			</div>
		</div>
		<div class='row'>
			<div class='col-sm-8'>
				<input type='text' class='form-control' name='Email' placeholder='ئەگەر دەتهەوێت پەیوەندیت دەگەڵ بگرینەوە تکایە ئیمەیلی خۆت بنووسە' value='' />
			</div>
			<div class='col-sm-2' style='padding-left: 0px;'>
			</div>
		</div>
		<div class='row'>
			<div class='col-sm-12'>
				<textarea class='form-control' placeholder='پوختەی باس' rows=7 name='Body'></textarea>
			</div>
		</div>
		<img id="captcha" src="securimage/securimage_show.png" alt="CAPTCHA Image" />
		<input type="text" name="captcha_code" size="30" maxlength="6" placeholder='نووسراوەی سەر وێنە لێرە بنووسە' />
		<a href="#" onclick="document.getElementById('captcha').src = 'securimage/securimage_showd41d.png?' + Math.random(); return false">[ وێنە بگۆڕە ]</a>
		<div class='row'>
			<div class='col-md-12 text-center'>
				<input type="submit" name='flexible' class='btn btn-primary send' value="بنێرە">
				<a class='btn btn-info send' href='index.html'>گەڕانەوە</a>
			</div>
		</div>
	</div>
</div>
</form>
<div class='container-fluid clearfix top-shadow' style='height:30px'></div>
 ...
 <div id="side-menu">
  ...
  <div class='container-fluid clearfix top-shadow hidden-xs' style='height:70px'>&nbsp;</div>
		...
		<div class='container-fluid '>
			<div class='row'>
				<div class='col-md-8 col-sm-12'>
					<a href='howto.html'>چۆن کار دەکات؟</a>
					<a href='faq.html'>پرسیار و وەڵام</a>
					<a href='support.html'>پشتیوانی</a>
					<a href='development.html'>فراژووتن</a>
					...
					<a href='aboutus.html'>دەربارەی هەورەفێرگە</a>
				...
				<div class='col-md-4 col-sm-12 copy-right text-left'>
					<div class="">© 2018-2020 تۆڕی پرۆگرامسازی ئومێددۆست.</div>
				</div>
			</div>
			<div class='row'>
				<div class='col-md-8 col-sm-12'>
	...
	<input type='hidden' id="signinRet" value='index26c3.html?mode=login' />
	<!-- Sign-in Modal -->
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<img id="forgotcaptcha" src="securimage/securimage_showbe10.png?namespace=forgot" alt="CAPTCHA Image" />
					...
					<a href="#" onclick="document.getElementById('forgotcaptcha').src = 'securimage/securimage_show6022.png?namespace=forgot&amp;' + Math.random(); return false">[ وێنە بگۆڕە ]</a>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<img id="regcaptcha" src="securimage/securimage_show.png" alt="CAPTCHA Image" />
					<input type="text" id='regcaptcha_code' name="regcaptcha_code" size="30" maxlength="6" placeholder='نووسراوەی سەر وێنە لێرە بنووسە' />
					<a href="#" onclick="document.getElementById('regcaptcha').src = 'securimage/securimage_showd41d.png?' + Math.random(); return false">[بگۆڕە]</a>
                    ...
                    success: function (html) {
                        if (html == 1) {
                          ...
                          //  alert('تێپەڕوشەی نوێ لە ڕێگای کورتەنامە و ئیمەیل بۆتان نێردرا');
							...
							document.getElementById('forgotcaptcha').src = 'securimage/securimage_show6022.png?namespace=forgot&amp;' + Math.random();
                        }
                    },
                    error: function () {
                    }
				...
				$.ajax({
                    ...
                    success: function (html) {
                        if (html == 1) {
                            ...
                            $('.signupMsg').text(html);
							document.getElementById('regcaptcha').src = 'securimage/securimage_showd41d.png?' + Math.random();
							$('#regcaptcha_code').val('');
                        }
                    },
                    error: function () {
...
<div style="visibility:hidden">0.0095620155334473</div></body>
